...
const Footer = () => {
  return (
    <footer className="bg-white lg:grid lg:grid-cols-5 max-w-[1800px] mx-auto">
      ...
      <div className="px-4 py-16 sm:px-6 lg:col-span-3 lg:px-8 border-t-0 sm:border-t-2 border-indigo-500">
            ...
            <ul className="mt-8 flex gap-6">
              <li>
                <a
                  ...
                  rel="noreferrer"
                  target="_blank"
                  className="transition hover:opacity-75 text-indigo-500"
                >
              ...
              <li>
                <a
                  ...
                  rel="noreferrer"
                  target="_blank"
                  className="text-indigo-500 transition hover:opacity-75"
                >
